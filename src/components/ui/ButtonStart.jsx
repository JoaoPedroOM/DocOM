...
const ButtonStart = ({children, onClick}) => {
  return (
    <button
      className="relative flex items-center px-3 py-3 overflow-hidden font-medium transition-all bg-blue-500 rounded-md group"
      onClick={onClick}
    >
      <span
